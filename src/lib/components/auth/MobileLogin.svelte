...
<div class="min-h-screen flex flex-col" style="background-color: var(--bg-app);">
	...
	<div class="px-6 mb-4">
		<div class="rounded-lg p-6 space-y-3" style="background-color: var(--bg-elevated); border: 1px solid var(--border-default);">
			<!-- LinkedTrust (primary) -->
			<button
				type="button"
				on:click={handleLinkedTrustLogin}
				disabled={isLoadingLinkedTrust || isLoading}
				class="w-full py-3 px-4 font-medium rounded-md transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed btn-primary text-base"
			>
